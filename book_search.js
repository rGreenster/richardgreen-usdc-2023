...
/** Example output object with results with stripped "." */
...
if (JSON.stringify(twentyLeaguesOut5) === JSON.stringify(test9result)) {
    console.log("PASS: Test 9 - negative search, partial match");
} else {
    console.log("FAIL: Test 9 - negative search, partial match");
